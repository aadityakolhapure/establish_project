...
if (isset($_POST['edit'])) {
	...
	$result = mysqli_query($conn, "update tbldepartments set DepartmentName = '$deptname' ,code = '$deptcode', DepartmentShortName ='$deptshortname' where id = '$get_id' ");
	if ($result) {
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="departmentcode" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['code']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
