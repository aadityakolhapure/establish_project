...
if (isset($_POST['add'])) {
	...
	if ($count > 0) {
		...
		$query = mysqli_query($conn, "insert into tbldepartments (DepartmentName, code, DepartmentShortName)
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="departmentcode" type="text" class="form-control" required="true" autocomplete="off" style="text-transform:uppercase">
											</div>
										</div>
									</div>
									<div class="row">
								...
								<table class="data-table table stripe hover nowrap">
									<thead>
										<tr>
											...
											<th class="table-plus">DEPARTMENT CODE</th>
