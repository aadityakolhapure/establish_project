...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/" alt=""></div>
					...
					<table class="data-table table stripe hover nowrap" id="table28">
						...
						<tbody>
							...
							$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status, tblleaves.admin_status 
                                    ...
                                    WHERE tblleaves.Status= '$status' AND tblleaves.admin_status = '$status'";
							...
							?>
								<tr>
									...
									<td><?php echo ($row['Status'] == 1) ? 'Approved' : (($row['Status'] == 2) ? 'Rejected' : 'Pending'); ?></td>
									<td><?php echo ($row['admin_status'] == 1) ? 'Approved' : (($row['admin_status'] == 2) ? 'Rejected' : 'Pending'); ?></td>
									<td>
